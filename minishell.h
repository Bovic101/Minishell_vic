...
void					lexer_redir_in(char *s, int *i, int *len,
							enum e_tokentype *type);
void					lexer_redir_out(char *s, int *i, int *len,
							enum e_tokentype *type);
char					*lexer_double_quotes(char *s, int *i, int *len,
							enum e_tokentype *type);
char					*lexer_single_quotes(char *s, int *i, int *len,
							enum e_tokentype *type);
void					lexer_word(char *s, int *i, int *len,
							enum e_tokentype *type);
